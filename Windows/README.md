...
```powershell
powershell -ExecutionPolicy Bypass -File scripts/build-windows.ps1 -Version 3.0.0-beta.1
```

The self-contained archive is written to `dist/TinySpectrum-3.0.0-beta.1-win-x64.zip`.
