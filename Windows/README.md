...
```powershell
powershell -ExecutionPolicy Bypass -File scripts/build-windows.ps1 -Version 2.4.0-beta.2
```

The self-contained archive is written to `dist/TinySpectrum-2.4.0-beta.2-win-x64.zip`.
