...
```powershell
powershell -ExecutionPolicy Bypass -File scripts/build-windows.ps1 -Version 0.2.0-beta.7
```

The self-contained archive is written to `dist/TinySpectrum-0.2.0-beta.7-win-x64.zip`.
